...
## Sistema de Pesquisa
O bot possui suporte ao sistema de pesquisa de slots de skills e registro de novos conhecimentos atrav�s do comando /pesquisa e /pesquisa registro. Toda a l�gica de gating, cache de assets e chamadas RPC com a API p�blica est� encapsulada nos utilit�rios pesquisaLogic.js, pesquisaAssets.js e pesquisaApi.js. Os endpoints correspondentes (no rkandia2) lidam com persist�ncia de banco e valida��o idempotente.
